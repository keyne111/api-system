package com.xiaofan.user.config;
...
import com.xiaofan.user.utils.SmsUtils;
    ...
    public void listenerDelayMessage(Map<String, String> msg)  {
        ...
        try {
            ...
            if (!resp.getCode().equals("OK")) {
                throw new BusinessException(ErrorCode.OPERATION_ERROR,"状态:"+resp.getCode()+"消息:"+resp.getMessage());
