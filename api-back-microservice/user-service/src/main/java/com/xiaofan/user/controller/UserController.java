...
import com.xiaofan.user.domain.common.DeleteRequest;
import com.xiaofan.user.domain.dto.*;
...
import static com.xiaofan.user.service.impl.UserServiceImpl.SALT;
/**
 * 用户接口
 */
@RestController
