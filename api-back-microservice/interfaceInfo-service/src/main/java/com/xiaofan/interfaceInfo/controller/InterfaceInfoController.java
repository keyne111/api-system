package com.xiaofan.interfaceInfo.controller;
...
import com.xiaofan.apicommon.enums.InterfaceInfoStatusEnum;
...
import com.xiaofan.interfaceInfo.annotation.AuthCheck;
import com.xiaofan.interfaceInfo.domain.common.DeleteRequest;
import com.xiaofan.interfaceInfo.domain.common.IdRequest;
import com.xiaofan.interfaceInfo.domain.dto.*;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> deleteInterfaceInfo(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldInterfaceInfo.getUserId().equals(user.getId()) && !userClient.isAdmin(user)) {
    ...
    public BaseResponse<Boolean> editInterfaceInfo(@RequestBody InterfaceInfoEditRequest interfaceInfoEditRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(oldInterfaceInfo == null, ErrorCode.NOT_FOUND_ERROR);
        // 仅本人或管理员可编辑
        if (!oldInterfaceInfo.getUserId().equals(loginUser.getId()) && !userClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
        boolean result = interfaceInfoService.updateById(interfaceInfo);
        return ResultUtils.success(result);
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest) {
        ...
        // 判断接口是否可以调用
        com.xiaofan.apiclientsdk.domain.po.User user = new com.xiaofan.apiclientsdk.domain.po.User();
        user.setUserName("xiaofan");
        String sdkresult = apilClient.getUserNameByPost(user);
        if (StringUtils.isBlank(sdkresult)) {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest invokeRequest, HttpServletRequest request) {
        ...
        ApilClient tempClient = new ApilClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.xiaofan.apiclientsdk.domain.po.User user = gson.fromJson(userRequestParams,com.xiaofan.apiclientsdk.domain.po.User.class);
