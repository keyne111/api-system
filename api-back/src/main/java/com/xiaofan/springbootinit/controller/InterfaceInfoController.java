...
import com.xiaofan.springbootinit.common.*;
...
import com.xiaofan.springbootinit.model.dto.interfaceinfo.*;
import com.xiaofan.springbootinit.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest) {
        ...
        // 判断接口是否可以调用
        com.xiaofan.apiclientsdk.model.User user = new com.xiaofan.apiclientsdk.model.User();
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest invokeRequest, HttpServletRequest request) {
        ...
        Gson gson = new Gson();
        com.xiaofan.apiclientsdk.model.User user = gson.fromJson(userRequestParams, com.xiaofan.apiclientsdk.model.User.class);
